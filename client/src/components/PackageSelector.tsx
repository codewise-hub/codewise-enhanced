          ...
          allPackages = [
            {
              id: 'basic-explorer',
              name: 'Basic Coder',
              description: 'For serious young coders',
              price: '349.00',
              currency: 'ZAR',
              duration: 'monthly',
              features: '["Unlimited Lessons", "Advanced Projects", "AI Tutor Access", "Certificates", "Parent Reports"]',
            ...
            },
            {
              ...
              currency: 'ZAR',
              duration: 'monthly',
              features: '["Everything in Basic", "1-on-1 Mentoring", "Advanced Robotics", "Portfolio Building", "Priority Support"]',
              packageType: 'individual',
              isActive: true
            },
            {
              ...
              currency: 'ZAR',
              duration: 'monthly',
              features: '["5 Coding Lessons", "Basic Projects", "Community Support", "Progress Tracking"]',
              packageType: 'individual',
              isActive: true
            },
            // School packages
