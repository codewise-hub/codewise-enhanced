...
import { Users, UserPlus, GraduationCap, School, Settings, BarChart3, Edit, Trash2, Mail, Phone } from "lucide-react";
...
export function SchoolAdminDashboard({ user }: SchoolAdminDashboardProps) {
  ...
  // Get school information - using mock data for demo
  const { data: school } = useQuery<School>({
    queryKey: ["/api/schools", user.schoolId || "demo"],
    queryFn: async () => {
      // Demo school data
      return {
        id: "demo-school-id",
  ...
  const { data: schoolUsers, isLoading: usersLoading } = useQuery<SchoolUser[]>({
    ...
    queryFn: async () => {
      ...
      return [
        {
          id: "teacher-1",
          email: "sarah.johnson@demoschoool.edu",
          name: "Sarah Johnson",
        ...
        {
          id: "teacher-2",
          email: "mike.wilson@demoschoool.edu", 
          name: "Mike Wilson",
          role: "teacher" as const,
        ...
        {
          id: "student-1",
          email: "alex.smith@demoschoool.edu",
          name: "Alex Smith",
        ...
        {
          id: "student-2",
          email: "emma.davis@demoschoool.edu",
          name: "Emma Davis",
          role: "student" as const,
          ageGroup: "6-11",
          grade: "Grade 5",
        ...
        {
          id: "student-3",
          email: "john.parker@demoschoool.edu",
          name: "John Parker",
          role: "student" as const,
          ageGroup: "12-17",
          grade: "Grade 9",
